...
export function validarEan13(raw) {
...
export function validarCode128(raw) {
...
export function validarCodigoBarras(type, raw) {
  if (type === 'EAN13') {
    return validarEan13(raw)
  }
  return validarCode128(raw)
}
