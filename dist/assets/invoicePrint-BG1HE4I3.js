import{t as e}from"./api-BwGJr1U7.js";import{D as t,a as n,n as r}from"./pinia-DDx8mYOQ.js";function i(e,t){return t!=null&&t!==``?`v-${t}`:`p-${e}`}var a={CASH:`EFECTIVO`,TRANSFER:`TRANSFERENCIA`},o=[{value:a.CASH,label:`Pago en efectivo`},{value:a.TRANSFER,label:`Transferencia virtual`}];function s(e){return o.find(t=>t.value===e)?.label||``}var c=r(`carrito`,()=>{let r=t([]),a=t(!1),o=t(``),c=t(``),l=t(``),u=t(null);function d(e){if(e.tipo===`variable`)return;let t=e.stock===-1?-1:Number(e.stock??0);if(t===0)return;let n=i(e.id,null),a=r.value.find(e=>e.lineKey===n);if(a){if(t>=0&&a.cantidad>=t)return;a.cantidad+=1;return}r.value.push({lineKey:n,productId:e.id,variationId:null,nombre:e.nombre,precio:Number(e.precio),cantidad:1,maxStock:t})}function f({productId:e,variationId:t,nombre:n,precio:a,stock:o}){let s=o===-1?-1:Number(o??0);if(s===0)return;let c=i(e,t),l=r.value.find(e=>e.lineKey===c);if(l){if(s>=0&&l.cantidad>=s)return;l.cantidad+=1;return}r.value.push({lineKey:c,productId:e,variationId:t,nombre:n,precio:Number(a),cantidad:1,maxStock:s})}function p(e,t){let n=Math.max(1,Math.floor(Number(t)||1)),a=e.variationId==null?null:e.variationId,o=i(e.id,a),s=e.maxStock==null?-1:e.maxStock,c=r.value.find(e=>e.lineKey===o);if(c){let e=s>=0?s:1/0;c.cantidad=Math.min(c.cantidad+n,e);return}r.value.push({lineKey:o,productId:e.id,variationId:a,nombre:e.nombre,precio:Number(e.precio),cantidad:Math.min(n,s>=0?s:n),maxStock:s>=0?s:-1})}function m(e){let t=r.value.find(t=>t.lineKey===e);t&&(t.maxStock>=0&&t.cantidad>=t.maxStock||(t.cantidad+=1))}function h(e){let t=r.value.find(t=>t.lineKey===e);if(t){if(t.cantidad<=1){g(e);return}--t.cantidad}}function g(e){r.value=r.value.filter(t=>t.lineKey!==e)}function _(){r.value=[]}function v(){u.value=null}let y=n(()=>r.value.reduce((e,t)=>e+t.precio*t.cantidad,0));async function b(t){a.value=!0,o.value=``,c.value=``;try{if(!l.value)throw Error(`Debes seleccionar un método de pago`);let n={payment_method:l.value,paymentMethod:l.value,items:r.value.map(({productId:e,variationId:t,cantidad:n})=>({productId:e,...t!=null&&t!==``?{variationId:t}:{},cantidad:n}))};t&&(t.id!=null||t.nombre&&String(t.nombre).trim()||t.telefono&&String(t.telefono).trim())&&(n.cliente={...t.id==null?{}:{id:t.id},nombre:t.nombre?String(t.nombre).trim():``,telefono:t.telefono?String(t.telefono).trim():``});let i=r.value.map(e=>({nombre:e.nombre,cantidad:e.cantidad,precio:e.precio,total:e.precio*e.cantidad})),a=r.value.reduce((e,t)=>e+t.precio*t.cantidad,0),o=t||{},{data:d}=await e.post(`/orden`,n),f=o.nombre&&String(o.nombre).trim()?String(o.nombre).trim():o.id==null?`Mostrador`:`Cliente #${o.id}`;return u.value={id:String(d.orderId),fecha:new Date().toISOString(),cliente:{nombre:f,documento:o.telefono?String(o.telefono).trim():``},items:i,total:a,metodo_pago:s(l.value)||l.value},c.value=`Orden #${d.orderId} creada correctamente`,_(),l.value=``,d}catch(e){throw o.value=e?.response?.data?.error||e?.message||`No se pudo crear la orden`,e}finally{a.value=!1}}return{items:r,creatingOrder:a,orderError:o,orderSuccess:c,paymentMethod:l,lastFactura:u,total:y,agregarProducto:d,agregarVariacion:f,agregarLinea:p,incrementar:m,decrementar:h,eliminar:g,limpiar:_,crearOrden:b,descartarUltimaFactura:v}});function l(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function u(e){return Number(e||0).toLocaleString(`es-CO`,{minimumFractionDigits:0,maximumFractionDigits:2})}function d(e){if(!e)return``;let t=String(e);return t.includes(`T`)?t.replace(`T`,` `).slice(0,19):t}function f(){return l(`Nari Universe`)}function p(e){let t=l(e.id),n=l(d(e.fecha)),r=f(),i=l(e.cliente?.nombre||`-`),a=l(e.cliente?.documento||``),o=l(e.metodo_pago||`POS`),s=u(e.total),c=(e.items||[]).map(e=>`
    <tr>
      <td>${l(e.nombre)}</td>
